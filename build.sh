...
xcrun swiftc -swift-version 5 -O -module-cache-path "$PWD/build/module-cache" \
  ...
  -target arm64-apple-macosx13.0 Sources/Quota.swift Sources/CodexClient.swift Sources/QuotaModel.swift Sources/PanelPlacement.swift Sources/GlassUI.swift Sources/App.swift \
...
cp LICENSE NOTICE PRIVACY.md SECURITY.md 'build/Codex Usage Monitor.app/Contents/Resources/'
